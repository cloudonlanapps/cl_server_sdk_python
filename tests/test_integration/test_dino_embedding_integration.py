...
@pytest.mark.asyncio
async def test_dino_embedding_http_polling(test_image: Path, client: ComputeClient):
...
@pytest.mark.integration
@pytest.mark.asyncio
async def test_dino_embedding_mqtt_callbacks(test_image: Path, client: ComputeClient):
