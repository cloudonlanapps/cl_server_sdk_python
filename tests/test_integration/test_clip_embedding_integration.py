...
@pytest.mark.asyncio
async def test_clip_embedding_http_polling(test_image: Path, client: ComputeClient):
...
@pytest.mark.integration
@pytest.mark.asyncio
async def test_clip_embedding_mqtt_callbacks(test_image: Path, client: ComputeClient):
...
@pytest.mark.integration
@pytest.mark.asyncio
async def test_clip_embedding_both_callbacks(test_image: Path, client: ComputeClient):
...
@pytest.mark.integration
@pytest.mark.asyncio
async def test_clip_embedding_file_download(test_image: Path, client: ComputeClient):
...
@pytest.mark.integration
@pytest.mark.asyncio
async def test_clip_embedding_worker_capabilities(test_image: Path, client: ComputeClient):
