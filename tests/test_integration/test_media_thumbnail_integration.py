...
@pytest.mark.asyncio
async def test_media_thumbnail_http_polling(test_image: Path, client: ComputeClient):
...
@pytest.mark.integration
@pytest.mark.asyncio
async def test_media_thumbnail_mqtt_callbacks(test_image: Path, client: ComputeClient):
...
@pytest.mark.integration
@pytest.mark.asyncio
async def test_media_thumbnail_both_callbacks(test_image: Path, client: ComputeClient):
...
@pytest.mark.integration
@pytest.mark.asyncio
async def test_media_thumbnail_worker_capabilities(test_image: Path, client: ComputeClient):
...
@pytest.mark.integration
@pytest.mark.asyncio
async def test_media_thumbnail_file_download(test_image: Path, client: ComputeClient):
